...
@property(retain, nonatomic) NSObject<TVTransportBarThumbnailScrubbing> *thumbnailScrubber; // @synthesize thumbnailScrubber=_thumbnailScrubber;
@property(retain, nonatomic) TVSPlayer *scrubPlayer; // @synthesize scrubPlayer=_scrubPlayer;
@property(retain, nonatomic) NSObject<TVSPlayback> *mainContentPlayer; // @synthesize mainContentPlayer=_mainContentPlayer;
