...
@class NSString, TVSImageProxy, TVTextEntryController, TVTextEntryHeaderView, UIImage, UITapGestureRecognizer, UITextField, _TVLTextEntryContentView, _TVLTextEntryFooterView;
...
@property(retain, nonatomic) TVSImageProxy *headerImageProxy; // @synthesize headerImageProxy=_headerImageProxy;
