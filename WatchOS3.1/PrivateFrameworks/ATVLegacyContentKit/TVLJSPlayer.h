...
#import <ATVLegacyContentKit/TVSPlaybackDelegate-Protocol.h>

@class NSArray, NSOperationQueue, NSSet, NSString, TVLLegacyJSContext, TVSInterstitialCollection, TVSStateMachine;
...
@property(retain) TVSInterstitialCollection *interstitialCollection; // @synthesize interstitialCollection=_interstitialCollection;
