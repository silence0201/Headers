...
@class TVBulletinView, UIImageView, UILabel;
...
@interface GKNotificationBannerView : UIView
{
    ...
    TVBulletinView *_tvBulletinView;
}

+ (_Bool)_preventsAppearanceProxyCustomization;
@property(nonatomic) TVBulletinView *tvBulletinView; // @synthesize tvBulletinView=_tvBulletinView;
