...
@class NSData, NSDate, NSDictionary, NSNumber, NSString, TVSPlaybackReportingEventCollection;
...
@property(nonatomic) NSNumber *rentalID; // @synthesize rentalID=_rentalID;
