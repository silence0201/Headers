...
@class BKSApplicationStateMonitor, NSOperationQueue, NSString, NSUUID, VSAccountStore, VSIdentityProviderController, VSPreferences, VSRemoteNotifier, VSViewServiceRequest;
