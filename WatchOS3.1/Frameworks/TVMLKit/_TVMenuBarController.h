...
@class IKAppMenuBarDocument, IKViewElement, NSArray, NSString, TVSPlayer;
...
@property(retain, nonatomic) TVSPlayer *nowPlayingPlayer; // @synthesize nowPlayingPlayer=_nowPlayingPlayer;
