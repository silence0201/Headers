...
- (void)startOpenOperationWithURL:(NSURL *)arg1 applicationIdentifier:(NSString *)arg2 userSpecifiedApplication:(_Bool)arg3 documentIdentifier:(NSString *)arg4 userInfo:(id)arg5 options:(NSDictionary *)arg6 completionHandler:(void (^)(_Bool, NSError *))arg7;
@end
