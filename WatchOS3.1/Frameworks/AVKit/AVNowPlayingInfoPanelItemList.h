...
@interface AVNowPlayingInfoPanelItemList : UICollectionViewController <UICollectionViewDelegateFlowLayout, AVNowPlayingInfoProtocol>
{
    ...
    _Bool _hasImages;
    _Bool _showNavigationMarkerImages;
...
@property(nonatomic) _Bool showNavigationMarkerImages; // @synthesize showNavigationMarkerImages=_showNavigationMarkerImages;
...
- (double)_itemHeight;
- (double)_totalHeight;
- (id)initWithIdentifier:(id)arg1 hasImages:(_Bool)arg2;
