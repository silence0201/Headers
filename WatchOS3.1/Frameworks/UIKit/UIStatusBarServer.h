...
+ (CDStruct_d68fcdaa *)getStatusBarOverrideData;
+ (const CDStruct_18395a89 *)getStatusBarData;
+ (void)permanentizeStatusBarOverrideData;
+ (void)postStatusBarOverrideData:(CDStruct_d68fcdaa *)arg1;
...
+ (void)postStatusBarData:(const CDStruct_18395a89 *)arg1 withActions:(int)arg2;
...
- (void)_receivedStatusBarData:(CDStruct_18395a89 *)arg1 actions:(int)arg2;
- (void)dealloc;
