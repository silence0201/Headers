...
@class NSArray, NSError, NSString, NSUUID, NSXPCConnection, SiriCoreLocalSpeechDESRecord;
...
- (void)startSpeechRecognitionWithLanguage:(id)arg1 task:(id)arg2 context:(id)arg3 narrowband:(_Bool)arg4 detectUtterances:(_Bool)arg5 maximumRecognitionDuration:(double)arg6 secureOfflineOnly:(_Bool)arg7 censorSpeech:(_Bool)arg8 didStartHandler:(CDUnknownBlockType)arg9;
