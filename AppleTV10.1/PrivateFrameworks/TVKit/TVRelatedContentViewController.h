...
- (double)_heightForContentType:(unsigned long long)arg1 withRelatedContent:(id)arg2 displayMode:(unsigned long long)arg3 parentContainerSize:(struct CGSize)arg4;
- (double)_widthForContentType:(unsigned long long)arg1 withRelatedContent:(id)arg2 displayMode:(unsigned long long)arg3 parentContainerSize:(struct CGSize)arg4;
