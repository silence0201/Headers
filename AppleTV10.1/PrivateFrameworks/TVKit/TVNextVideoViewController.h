...
@class NSLayoutConstraint, NSNumber, NSString, NSURL, TVSImagePromise, UIButton, UILabel, UIView;
...
@property(retain, nonatomic) TVSImagePromise *imagePromise; // @synthesize imagePromise=_imagePromise;
