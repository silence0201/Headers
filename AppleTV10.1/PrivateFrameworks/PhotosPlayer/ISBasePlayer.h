...
@property(nonatomic, setter=_setAudioEnabledInternal:) _Bool _audioEnabledInternal; // @synthesize _audioEnabledInternal=__audioEnabledInternal;
...
- (void)behavior:(id)arg1 setAudioEnabled:(_Bool)arg2;
...
- (void)_setAudioDisabled:(_Bool)arg1 forReason:(id)arg2;
- (void)_audioEnabledInternal:(_Bool)arg1;
