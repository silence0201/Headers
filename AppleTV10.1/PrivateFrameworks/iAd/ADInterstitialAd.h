...
@class ADAdSpace, ADInterstitialView, ADTVInterstitialMediaViewController, NSString, UIView, UIViewController;
...
@property(retain, nonatomic) ADTVInterstitialMediaViewController *presentationViewController; // @synthesize presentationViewController=_presentationViewController;
