...
@class NSMutableSet, NSSet, TXRXCFileAttributes;
...
@property(retain, nonatomic) TXRXCFileAttributes *baseFileAttributes; // @synthesize baseFileAttributes=_baseFileAttributes;
- (void).cxx_destruct;
