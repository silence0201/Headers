...
- (void)transitionToTracking:(_Bool)arg1 mapMode:(long long)arg2 startLocation:(CDStruct_c3b9c2ee)arg3 cameraController:(id)arg4 pounceCompletionHandler:(CDUnknownBlockType)arg5;
