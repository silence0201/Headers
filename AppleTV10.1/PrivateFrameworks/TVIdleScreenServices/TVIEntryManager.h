...
{
    _Bool _bypassStoreDemoMode;
    _Bool _shouldDownloadAssetCollection;
...
- (void).cxx_destruct;
- (_Bool)_hasCachedAssets;
- (_Bool)_purgeOldestAsset;
...
- (void)_processAvailableEntriesWithDocument:(id)arg1 storeDemoModeEnabled:(_Bool)arg2;
- (void)_invalidateURLSession;
- (void)setEntryRefreshInterval:(long long)arg1;
- (id)previouslySelectedEntry;
- (id)selectedEntry;
@property(readonly, nonatomic) TVIEntry *entryForRefresh;
