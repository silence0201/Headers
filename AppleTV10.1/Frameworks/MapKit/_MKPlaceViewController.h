...
@class CNContact, CNContactNavigationController, GEOAutomobileOptions, GEORouteGenerator, GEOTransitOptions, MKMapItem, NSString, _MKPlaceActionButtonController;
...
@property(nonatomic) double currentHeaderMinimalModeInterpolationFactor; // @synthesize currentHeaderMinimalModeInterpolationFactor=_currentHeaderMinimalModeInterpolationFactor;
