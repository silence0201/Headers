...
- (void)startOpenOperationWithURL:(id)arg1 applicationIdentifier:(id)arg2 userSpecifiedApplication:(_Bool)arg3 documentIdentifier:(id)arg4 userInfo:(id)arg5 options:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
