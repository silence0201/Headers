...
struct ResourceError {
    ...
    int _field5;
    _Bool _field6;
    struct RetainPtr<__CFError *> _field7;
    struct RetainPtr<NSError> _field8;
};
...
struct ResourceResponse {
    ...
    _Bool _field26;
    unsigned int :3;
    struct RetainPtr<_CFURLResponse *> _field27;
...
struct WebPage {
    ...
    struct Ref<WebKit::WebUserContentController> _field62;
    ...
    _Bool _field88;
    struct RefPtr<WebCore::Range> _field89;
    struct RefPtr<WebCore::Node> _field90;
    struct IntPoint _field91;
    int _field92;
    struct RefPtr<WebCore::Node> _field93;
    struct FloatPoint _field94;
    struct ViewportConfiguration _field95;
    _Bool _field96;
    _Bool _field97;
    _Bool _field98;
    _Bool _field99;
    ...
    _Bool _field101;
    _Bool _field102;
    struct duration<long long, std::__1::ratio<1, 1000>> _field103;
    struct duration<long long, std::__1::ratio<1, 1000>> _field104;
    struct FloatSize _field105;
    struct FloatSize _field106;
    struct RefPtr<WebCore::Range> _field107;
    struct IntRect _field108;
    struct RefPtr<WebCore::Range> _field109;
    struct IntSize _field110;
    struct FloatSize _field111;
    int _field112;
    _Bool _field113;
    struct HashMap<std::__1::pair<WebCore::IntSize, double>, WebCore::IntPoint, WTF::PairHash<WebCore::IntSize, double>, WTF::HashTraits<std::__1::pair<WebCore::IntSize, double>>, WTF::HashTraits<WebCore::IntPoint>> _field114;
    struct RefPtr<WebCore::Node> _field115;
    struct FloatPoint _field116;
    struct FloatRect _field117;
    struct Timer _field118;
    struct Vector<std::__1::function<void ()>, 0, WTF::CrashOnOverflow, 16> _field119;
    _Bool _field120;
    struct HashSet<WTF::String, WTF::ASCIICaseInsensitiveHash, WTF::HashTraits<WTF::String>> _field121;
    struct Color _field122;
    struct HashSet<unsigned int, WTF::IntHash<unsigned int>, WTF::HashTraits<unsigned int>> _field123;
    unsigned int _field124;
    int _field125;
    struct Optional<WebCore::ScrollbarOverlayStyle> _field126;
    _Bool _field127;
    unsigned int _field128;
    unsigned int _field129;
    _Bool _field130;
    struct UserActivity _field131;
...
struct WebPageProxy {
    ...
    struct VisibleContentRectUpdateInfo _field40;
    _Bool _field41;
    ...
    struct RefPtr<API::HitTestResult> _field55;
    struct RefPtr<WebKit::WebOpenPanelResultListenerProxy> _field56;
    struct GeolocationPermissionRequestManagerProxy _field57;
    struct NotificationPermissionRequestManagerProxy _field58;
    struct UserMediaPermissionRequestManagerProxy _field59;
    unsigned int _field60;
    _Bool _field61;
    _Bool _field62;
    _Bool _field63;
    struct RefPtr<WTF::RefCounter<WebKit::ProcessThrottler::ForegroundActivityCounterType>::Count> _field64;
    _Bool _field65;
    struct Ref<WebKit::WebBackForwardList> _field66;
    _Bool _field67;
    struct String _field68;
    struct EditorState _field69;
    _Bool _field70;
    double _field71;
    double _field72;
    double _field73;
    ...
    _Bool _field98;
    _Bool _field99;
    struct ResourceRequest *_field100;
    _Bool _field101;
    int _field102;
    struct DownloadID _field103;
    _Bool _field104;
    _Bool _field105;
    int _field106;
    ...
    _Bool _field112;
    struct unique_ptr<WebKit::NativeWebMouseEvent, std::__1::default_delete<WebKit::NativeWebMouseEvent>> _field113;
    ...
    _Bool _field160;
    _Bool _field161;
    struct HashMap<WTF::String, WTF::String, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WTF::String>> _field162;
    struct unique_ptr<WebCore::RunLoopObserver, std::__1::default_delete<WebCore::RunLoopObserver>> _field163;
    struct unique_ptr<WebKit::RemoteLayerTreeScrollingPerformanceData, std::__1::default_delete<WebKit::RemoteLayerTreeScrollingPerformanceData>> _field164;
    _Bool _field165;
    struct RefPtr<WTF::RefCounter<WebKit::UserObservablePageCounterType>::Count> _field166;
    struct RefPtr<WTF::RefCounter<WebKit::ProcessSuppressionDisabledCounterType>::Count> _field167;
    struct RefPtr<WTF::RefCounter<WebKit::HiddenPageThrottlingAutoIncreasesCounterType>::Count> _field168;
    int _field169;
    struct Optional<WebCore::ScrollbarOverlayStyle> _field170;
    unsigned long long _field171;
    struct HashMap<WTF::String, WebKit::WebPreferencesStore::Value, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WebKit::WebPreferencesStore::Value>> _field172;
    unsigned int _field173;
    _Bool _field174;
    struct Vector<unsigned long long, 0, WTF::CrashOnOverflow, 16> _field175;
    ...
    _Bool _field180;
    _Bool _field181;
    struct unique_ptr<WebKit::NodeAssistanceArguments, std::__1::default_delete<WebKit::NodeAssistanceArguments>> _field182;
    _Bool _field183;
    _Bool _field184;
};
