...
@class NSMutableArray, NSString, NSTimer, NSUUID, TVSIRVolumeButtonConfiguration;
@protocol OS_dispatch_queue, TVSExternalControlSystemDelegate;

@interface TVSExternalControlSystem : NSObject
{
...
@property(retain, nonatomic) NSTimer *coreAudioVolumeRepeatTimer; // @synthesize coreAudioVolumeRepeatTimer=_coreAudioVolumeRepeatTimer;
@property(retain, nonatomic) NSTimer *rapidCoreAudioVolumeButtonReleaseTimer; // @synthesize rapidCoreAudioVolumeButtonReleaseTimer=_rapidCoreAudioVolumeButtonReleaseTimer;
...
@property(retain, nonatomic) TVSIRVolumeButtonConfiguration *effectiveVolumeButtonConfiguration; // @synthesize effectiveVolumeButtonConfiguration=_effectiveVolumeButtonConfiguration;
...
@property(retain, nonatomic) NSString *volumeDeviceName; // @synthesize volumeDeviceName=_volumeDeviceName;
@property(retain, nonatomic) TVSIRVolumeButtonConfiguration *selectedVolumeButtonConfiguration; // @synthesize selectedVolumeButtonConfiguration=_selectedVolumeButtonConfiguration;
@property(nonatomic) __weak id <TVSExternalControlSystemDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (_Bool)_setCoreControlPolicyPreference:(int)arg1 forFeature:(id)arg2;
...
- (_Bool)_isAutomaticallyConfiguredForFeature:(id)arg1;
