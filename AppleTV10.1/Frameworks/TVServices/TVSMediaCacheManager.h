...
@class AVAssetCache, AVAssetDownloadSession, AVQueuePlayer, NSArray, NSDate, NSMutableArray, NSNumber, NSTimer, TVSMediaItemLoader, TVSPlayerItem, TVSStateMachine, TVSTimeRange;
...
@property(retain, nonatomic) TVSPlayerItem *playerItem; // @synthesize playerItem=_playerItem;
...
@property(retain, nonatomic) TVSMediaItemLoader *mediaItemLoader; // @synthesize mediaItemLoader=_mediaItemLoader;
...
@property(retain, nonatomic) TVSTimeRange *currentMediaItemBufferedTimeRange; // @synthesize currentMediaItemBufferedTimeRange=_currentMediaItemBufferedTimeRange;
