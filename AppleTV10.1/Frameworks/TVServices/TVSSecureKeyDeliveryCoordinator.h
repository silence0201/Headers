...
@class NSData, NSMutableSet, NSString, TVSPlaybackReportingEventCollection, TVSSecureKeyLoader;
...
@property(nonatomic) __weak NSObject<TVSSecureKeyDeliveryCoordinatorDelegate> *delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
