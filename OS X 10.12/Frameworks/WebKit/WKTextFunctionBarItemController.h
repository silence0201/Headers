...
#import <AppKit/NSTextFunctionBarItemController.h>
...
@interface WKTextFunctionBarItemController : NSTextFunctionBarItemController <NSCandidateListTouchBarItemDelegate, NSTouchBarDelegate>
{
    BOOL _textIsBold;
    BOOL _textIsItalic;
    ...
    struct RetainPtr<_WKTextListFunctionBarViewController> _wkTextListFunctionBarViewController;
...
- (id)textListFunctionBarViewController;
