...
@class NSString, WKPreferences, WKProcessPool, WKUserContentController, WKWebView, WKWebsiteDataStore, _WKVisitedLinkProvider, _WKVisitedLinkStore, _WKWebsiteDataStore;
