...
@class AKPinFieldView, AKTouchBarController, CDPContext, CDPDevice, CDPRemoteDeviceSecretValidator, IASPickerViewController, NSArray, NSButton, NSLayoutConstraint, NSMutableArray, NSNumber, NSProgressIndicator, NSSecureTextField, NSString, NSTextField, NSTouchBar, NSView, NSWindow;
