...
@class NPKeyBag, NPTunnelTuscanyEndpoint, NPWaldo, NSData, NSDate, NSMutableDictionary, NSPKeyNetworkAgent, NSPNetworkAgent, NSString, NSUUID, NWHostEndpoint, NWNetworkAgentRegistration;
...
@property unsigned long long receivedUsageUpdates; // @synthesize receivedUsageUpdates=_receivedUsageUpdates;
@property(retain) NSMutableDictionary *outstandingAssertions; // @synthesize outstandingAssertions=_outstandingAssertions;
...
@property(retain) NSPNetworkAgent *currentAgent; // @synthesize currentAgent=_currentAgent;
