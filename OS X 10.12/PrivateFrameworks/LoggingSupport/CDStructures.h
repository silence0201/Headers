...
struct os_activity_stream_entry_s {
    ...
    union {
        ...
        struct os_activity_breadcrumb_s _field9;
        struct os_activity_stream_activity_s _field10;
        struct os_trace_message_s _field11;
    } _field8;
};
