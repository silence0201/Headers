...
@class BookmarksView, BrowserWKView, ContinuousPageView, DimmingView, NSClipView, NSHashTable, NSString, ReaderWKView, ResizableContentContainer, TabDialogView;
...
- (void)installTabDialogView:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
