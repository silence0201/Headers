...
- (void)_emptyImageCaches;
- (void)_hideBookmarksMenu;
- (void)_handleURLEvent:(id)arg1 withReplyEvent:(id)arg2;
- (void)_handleShowSafariExtensionsPreferencesEvent:(id)arg1 withReplyEvent:(id)arg2;
- (BOOL)_shouldShowSafariExtensionsPreferences:(id)arg1;
