...
@class DOMDocument, DOMDocumentFragment, DOMElement, LPCSSResolver, LPCaptionBarPresentationProperties, LPHTMLComponent, LPImage, LPLinkMetadata, LPMetadataProvider, LPTheme, LPVideo, NSColor, NSString, NSURL;
