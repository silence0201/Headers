...
@class CJKCandidateUIStringProperties, NSAttributedString, NSString;

@interface CJKCandidateUIString : NSObject
{
    CJKCandidateUIStringProperties *_properties;
    NSString *_string;
...
@property(retain, nonatomic) CJKCandidateUIStringProperties *properties; // @synthesize properties=_properties;
- (id)ellipticalAttributedString:(double)arg1 isVerticallyAligned:(BOOL)arg2;
