...
@class NSCachedURLResponse, NSError, NSHTTPURLResponse, NSInputStream, NSNumber, NSURLAuthenticationChallenge, NSURLRequest, NSURLResponse, __NSCFURLSessionConnection;
