...
@class NSInputStream, NSOutputStream, NSString, NSURL, __NSCFURLSessionConnection, __NSURLSessionLocal;
...
@interface __NSCFLocalSessionTask : __NSCFURLSessionTask <NSURLSessionTaskSubclass, NSURLSessionDataTaskSubclass, NSURLSessionUploadTaskSubclass, SessionConnectionDelegate>
{
    ...
    struct dispatch_source_s *_startTimeoutTimer;
    struct dispatch_source_s *_payloadTransmissionTimer;
    struct dispatch_source_s *_willSendRequestTimer;
...
- (void)_onqueue_startTimer:(struct dispatch_source_s *)arg1 withTimeoutInNanos:(long long)arg2 streamErrorCode:(int)arg3;
