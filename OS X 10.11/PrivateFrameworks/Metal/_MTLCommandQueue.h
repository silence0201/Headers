...
@interface _MTLCommandQueue : NSObject
{
    ...
    struct dispatch_group_s *_submittedGroup;
    struct dispatch_queue_s *_commandQueueDispatch;
    struct dispatch_source_s *_commandQueueEventSource;
    struct dispatch_semaphore_s *_commandBufferSemaphore;
    NSString *_label;
