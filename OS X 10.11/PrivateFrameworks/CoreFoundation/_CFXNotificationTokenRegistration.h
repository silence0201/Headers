...
+ (id)createTokenRegistration:(int)arg1 token:(unsigned long long)arg2 connection:(struct _xpc_connection_s *)arg3 notifyToken:(int)arg4 options:(unsigned long long)arg5 queue:(id)arg6 handler:(CDUnknownBlockType)arg7;
