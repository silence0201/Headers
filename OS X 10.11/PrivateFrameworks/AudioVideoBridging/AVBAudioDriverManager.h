...
#import <AudioVideoBridging/AVBCAPlugin.h>

#import <AudioVideoBridging/AVBCACoreAudioClient-Protocol.h>

@class NSString;

@interface AVBAudioDriverManager : AVBCAPlugin <AVBCACoreAudioClient>
{
}
