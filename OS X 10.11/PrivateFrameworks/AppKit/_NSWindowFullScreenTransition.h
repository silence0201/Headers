...
- (void)exitFullScreenTransitionForWindow:(id)arg1 options:(CDStruct_e91cbfd5)arg2;
- (void)_performExitFullScreenModeForWindow:(id)arg1 windowController:(id)arg2 options:(CDStruct_e91cbfd5)arg3 customWindows:(id)arg4 doKitAnimation:(BOOL)arg5;
