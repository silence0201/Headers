...
- (id)initWithActiveTileID:(unsigned long long)arg1 coverTileID:(unsigned long long)arg2 coveredWindowTileFrame:(struct CGRect)arg3 parentSpaceID:(unsigned long long)arg4 ignoreEvents:(BOOL)arg5 screen:(id)arg6;
