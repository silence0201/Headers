...
@class ABCDContact, ABCardView, ABCardViewSaveHelper, ABCardViewUndoableDataSource, ABCommandExecutor, ABPerson, ABRemovesEmptyCardViewData, AKCardViewDataSource, AKCardViewDataSourceFactory, NSString, NSUndoManager, SGRealtimeContact;
...
@property BOOL shouldShowSuggestedFields; // @synthesize shouldShowSuggestedFields=_shouldShowSuggestedFields;
