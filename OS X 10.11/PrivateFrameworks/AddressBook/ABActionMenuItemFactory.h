...
- (id)actionMenuItemsForPersonUniqueId:(id)arg1 inAddressBook:(id)arg2 property:(id)arg3 identifier:(id)arg4 value:(id)arg5 isSuggested:(BOOL)arg6;
- (id)actionMenuItemsForPersonUniqueId:(id)arg1 inAddressBook:(id)arg2 property:(id)arg3 identifier:(id)arg4;
- (id)actionMenuItemsForPersonUniqueId:(id)arg1 property:(id)arg2 identifier:(id)arg3 value:(id)arg4 isSuggested:(BOOL)arg5;
...
- (id)actionsForPerson:(id)arg1 property:(id)arg2 identifier:(id)arg3 value:(id)arg4 isSuggested:(BOOL)arg5;
- (void)dealloc;
