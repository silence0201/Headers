...
@class ABAccount, ABActionAutovalidator, ABAddressBook, ABCommandExecutor, ABGroup, ABKeystrokeForwarder, ABMainListOutlineView, ABPersonEntriesList, ABPersonListDragExportHelper, ABPersonListMenuHelper, ABPersonListSearchHelper, CNManualObservable, NSArray, NSDictionary, NSMutableArray, NSMutableIndexSet, NSOutlineView, NSString, NSUndoManager;
...
@interface ABPersonListController : NSResponder <ABPersonListControllerProtocol, NSOutlineViewDelegate, NSOutlineViewDataSource, ABBookStateSaving>
{
    ...
    CNManualObservable *_selectionObservable;
...
@property(copy) CNManualObservable *selectionObservable; // @synthesize selectionObservable=_selectionObservable;
