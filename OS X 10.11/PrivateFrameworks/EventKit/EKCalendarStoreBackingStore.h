...
+ (BOOL)_loadSuggestionsFramework;
...
- (void)_forceUpdateBackingStoreItemsWithObjectIDs:(id)arg1 inContext:(id)arg2;
- (void)_forceUpdateBackingStoreItemsWithObjectIDs:(id)arg1;
- (void)refreshSources;
