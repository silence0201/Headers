...
@class CALayer, CLLocation, GEOMapRegion, GEOResourceManifestConfiguration, MKAccessibilityItem, MKAnnotationContainerView, MKAnnotationView, MKAttributionLabel, MKCompassView, MKLabelMarker, MKMapAnnotationManager, MKMapCamera, MKMapGestureController, MKMapViewInternal, MKOverlayContainerView, MKRotationFilter, MKScaleView, MKUserLocation, NSArray, NSClickGestureRecognizer, NSImageView, NSLayoutConstraint, NSLayoutGuide, NSOrderedSet, NSSegmentedControl, NSString, VKMapView, VKPuckAnimator, VKRouteContext, _MKAnnotationDragGestureRecognizer, _MKEnvironmentLabel;
@protocol MKMapViewDelegate, MKMapViewDelegate><MKMapViewDelegatePrivate;

@interface MKMapView : NSView <VKPuckAnimatorDelegate, MKOverlayContainerViewDelegate, MKMouseOverLabelRecognizerDelegate, MKMouseOverLabelTarget, MKAnnotationContainerViewDelegate, VKMapViewDelegate, MKMapGestureControllerDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, NSGestureRecognizerDelegate, MKRotationFilterDelegate, GEOResourceManifestTileGroupObserver, NSCoding>
{
...
- (void)_showAnimationAtCoordinate:(struct CLLocationCoordinate2D)arg1 withMapRegion:(id)arg2;
...
- (CDStruct_02837cd9)visibleMapRectOfInterest;
