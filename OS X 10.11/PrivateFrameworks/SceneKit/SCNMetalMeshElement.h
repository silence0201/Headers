...
-     // Error parsing type: v24@0:8^{__C3DMeshElement={__C3DEntity={__CFRuntimeBase=Q[4C]I}^v^{__CFString}^{__CFString}^{__CFDictionary}qq}^{__CFData}III^{__C3DMeshElement}CCCc^v^{__C3DMeshSource}[2]}16, name: setupWithElement:
- (void)dealloc;
