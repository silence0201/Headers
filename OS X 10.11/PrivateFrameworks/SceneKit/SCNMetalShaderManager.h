...
- (id)renderResourceForProgram:(struct __C3DFXProgram *)arg1 material:(struct __C3DMaterial *)arg2 geometry:(struct __C3DGeometry *)arg3 pass:(struct __C3DFXPass *)arg4 renderMesh:(id)arg5 blendStates:(struct __C3DBlendStates *)arg6;
