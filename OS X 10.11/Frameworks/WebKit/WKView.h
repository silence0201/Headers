...
- (void)_didPerformImmediateActionHitTest:(const struct Data *)arg1 contentPreventsDefault:(BOOL)arg2 userData:(struct Object *)arg3;
...
- (void)_setPromisedDataForImage:(struct Image *)arg1 withFileName:(id)arg2 withExtension:(id)arg3 withTitle:(id)arg4 withURL:(id)arg5 withVisibleURL:(id)arg6 withArchive:(struct SharedBuffer *)arg7 forPasteboard:(id)arg8;
- (void)_setFileAndURLTypes:(id)arg1 withExtension:(id)arg2 withTitle:(id)arg3 withURL:(id)arg4 withVisibleURL:(id)arg5 forPasteboard:(id)arg6;
- (void)_dragImageForView:(id)arg1 withImage:(id)arg2 at:(struct CGPoint)arg3 linkDrag:(BOOL)arg4;
...
- (void)_clearTextIndicatorWithAnimation:(int)arg1;
- (void)_setTextIndicator:(struct TextIndicator *)arg1 withLifetime:(int)arg2;
- (void)_setTextIndicator:(struct TextIndicator *)arg1;
- (void)touchesCancelledWithEvent:(id)arg1;
- (void)touchesEndedWithEvent:(id)arg1;
- (void)touchesMovedWithEvent:(id)arg1;
- (void)touchesBeganWithEvent:(id)arg1;
- (Vector_dafbf6d3)_touchesOrderedByAge;
...
- (void)_collectKeyboardLayoutCommandsForEvent:(id)arg1 to:(Vector_b180ff1e *)arg2;
