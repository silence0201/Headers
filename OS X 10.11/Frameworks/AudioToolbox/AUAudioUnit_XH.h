...
@class AUAudioUnitBusArray_XH, AUParameterTree, NSExtension, NSUUID;
...
@interface AUAudioUnit_XH : AUAudioUnit
{
    ...
    struct dispatch_queue_s *_propListenerQueue;
    ...
    struct dispatch_queue_s *_viewControllerRequestQueue;
