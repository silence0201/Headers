...
@class AUAudioUnit, AUAudioUnitViewService, AUParameterTree, NSMutableArray;
...
@interface AURemoteExtensionContext : NSExtensionContext <AUAudioUnitXPCProtocol>
{
    ...
    struct dispatch_queue_s *_propertyObserverQueue;
    NSMutableArray *_pendingChangedProperties;
    int _deferPropertyChangeNotifications;
    struct voucher_s *_initializationVoucher;
