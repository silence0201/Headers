...
@class ABAddressBook, ABCNContact, ABCNContactStore, ABCardView, ABCardViewPersonMapper, AKCardViewFaceTimeAvailabilityWatcher, AKCardViewImageDataSource, CNWeakReference, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSString, SGContact;
