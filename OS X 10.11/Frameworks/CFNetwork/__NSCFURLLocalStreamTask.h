...
@class NSData, NSDictionary, NSError, NSMutableArray, NSString, NSURLRequest, NSURLResponse, __NSURLSessionLocal;
...
@interface __NSCFURLLocalStreamTask : NSURLSessionTask
{
    ...
    BOOL _goneSecure;
    struct dispatch_source_s *_tickerTimeoutTimer;
...
- (void)_onqueue_postConnectConfiguration:(struct tcp_connection_s *)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_onqueue_preConnectionConfiguration:(struct tcp_connection_s *)arg1 completionHandler:(CDUnknownBlockType)arg2;
