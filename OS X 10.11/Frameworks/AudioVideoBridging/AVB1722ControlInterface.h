...
@interface AVB1722ControlInterface : NSObject
{
    ...
    struct dispatch_queue_s *_commandsQueue;
    struct dispatch_queue_s *_transportQueue;
...
@property(readonly, nonatomic) struct dispatch_queue_s *callbackQueue; // @dynamic callbackQueue;
@property(readonly, nonatomic) struct dispatch_queue_s *commandsQueue; // @dynamic commandsQueue;
