...
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forMasterGlobalProperty:(unsigned int)arg2 removeListener:(CDUnknownBlockType)arg3;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forGlobalProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 removeListener:(CDUnknownBlockType)arg4;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forMasterOutputProperty:(unsigned int)arg2 removeListener:(CDUnknownBlockType)arg3;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forOutputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 removeListener:(CDUnknownBlockType)arg4;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forMasterInputProperty:(unsigned int)arg2 removeListener:(CDUnknownBlockType)arg3;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forInputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 removeListener:(CDUnknownBlockType)arg4;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forProperty:(unsigned int)arg2 scope:(unsigned int)arg3 ofElement:(unsigned int)arg4 removeListener:(CDUnknownBlockType)arg5;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forMasterGlobalProperty:(unsigned int)arg2 addListener:(CDUnknownBlockType)arg3;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forGlobalProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 addListener:(CDUnknownBlockType)arg4;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forMasterOutputProperty:(unsigned int)arg2 addListener:(CDUnknownBlockType)arg3;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forOutputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 addListener:(CDUnknownBlockType)arg4;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forMasterInputProperty:(unsigned int)arg2 addListener:(CDUnknownBlockType)arg3;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forInputProperty:(unsigned int)arg2 ofElement:(unsigned int)arg3 addListener:(CDUnknownBlockType)arg4;
- (BOOL)onQueue:(struct dispatch_queue_s *)arg1 forProperty:(unsigned int)arg2 scope:(unsigned int)arg3 ofElement:(unsigned int)arg4 addListener:(CDUnknownBlockType)arg5;
