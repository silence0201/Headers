...
@class AVB17221ACMPInterface, AVB17221AECPInterface, AVB17221EntityDiscovery, AVB1722MAAP, AVBInterface, AVBMSRPDomain, AVBMSRPListener, AVBMSRPTalker, AVBMVRP, AVBNetworkClient, TSgPTPClock;
...
- (void)didRemoveTimeSync:(TSgPTPClock *)arg1 onInterface:(AVBInterface *)arg2;
- (void)didAddTimeSync:(TSgPTPClock *)arg1 onInterface:(AVBInterface *)arg2;
