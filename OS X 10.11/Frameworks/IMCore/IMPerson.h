...
@class ABAddressBook, ABCNContact, ABPerson, NSArray, NSData, NSString;
...
+ (id)allPeople;
@property(retain, nonatomic) ABCNContact *cnContact; // @synthesize cnContact=_cnContact;
