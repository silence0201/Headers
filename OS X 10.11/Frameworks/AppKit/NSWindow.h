...
- (void)_doSnappingForWindowMovedEvent:(id)arg1;
...
- (void)_fromConstraintsGetWindowMinSize:(struct CGSize *)arg1 maxSize:(struct CGSize *)arg2 allowDynamicLayout:(BOOL)arg3;
