...
- (BOOL)_batchRespondToSharedCalendarInvitation:(id)arg1 withStatus:(int)arg2 error:(id *)arg3;
- (BOOL)batchRespondToSharedCalendarInvitation:(id)arg1 withStatus:(int)arg2 error:(id *)arg3;
...
- (id)itemsWithIdentifiers:(id)arg1;
