...
- (id)imageWithExtent:(struct CGRect)arg1 processorDescription:(id)arg2 argumentDigest:(unsigned long long)arg3 inputFormat:(int)arg4 outputFormat:(int)arg5 roiCallback:(CDUnknownBlockType)arg6 processor:(CDUnknownBlockType)arg7 options:(id)arg8;
