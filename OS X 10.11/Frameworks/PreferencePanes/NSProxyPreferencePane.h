...
@class NSLayerCentricRemoteView, NSString, NSXPCConnection;
...
@interface NSProxyPreferencePane : NSPreferencePane <PreferencePaneHostProtocol>
{
    ...
    NSLayerCentricRemoteView *_remoteView;
}

@property(retain) NSLayerCentricRemoteView *remoteView; // @synthesize remoteView=_remoteView;
