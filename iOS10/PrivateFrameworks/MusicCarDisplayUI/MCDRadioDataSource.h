...
@property(retain, nonatomic) MCDRadioPlaybackCoordinator *playbackCoordinator; // @synthesize playbackCoordinator=_playbackCoordinator;
@property(retain, nonatomic) NSArray *featuredStations; // @synthesize featuredStations=_featuredStations;
@property(nonatomic) __weak id <MCDRadioDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
