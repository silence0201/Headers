...
@property(readonly, nonatomic) _Bool isItunes; // @synthesize isItunes=_isItunes;
...
- (id)initWithBundleId:(id)arg1 timestamp:(id)arg2 duration:(id)arg3 elapsedTime:(id)arg4 externalProfileID:(id)arg5 contentID:(id)arg6 isItunes:(_Bool)arg7 accountID:(id)arg8 playbackState:(long long)arg9 playbackRate:(id)arg10 completionState:(long long)arg11;
