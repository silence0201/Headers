...
#import <VideoSubscriberAccount/VSDeveloperAttributeCellDelegate-Protocol.h>
#import <VideoSubscriberAccount/VSDeveloperIdentityProviderViewController-Protocol.h>
