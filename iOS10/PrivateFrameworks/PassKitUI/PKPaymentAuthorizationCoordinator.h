...
+ (_Bool)canMakePaymentsUsingNetworks:(id)arg1 capabilities:(unsigned long long)arg2 isWebPayment:(_Bool)arg3;
+ (_Bool)canMakePaymentsUsingNetworks:(id)arg1 isWebPayment:(_Bool)arg2;
