...
@property(readonly, retain, nonatomic) NSMutableArray *coalescedNotificationRequests; // @synthesize coalescedNotificationRequests=_coalescedNotificationRequests;
- (void).cxx_destruct;
- (id)hintText;
- (id)interfaceActions;
- (id)thumbnail;
