...
- (id)_newDownloadSessionForPlaybackItemMetadata:(id)arg1 sourceURL:(id)arg2 downloadKey:(id)arg3 sinfs:(id)arg4 pathExtension:(id)arg5 assetFlavor:(id)arg6 allowAssetCaching:(_Bool)arg7 protectionType:(unsigned long long)arg8 returningAssetDownloadSession:(id *)arg9;
