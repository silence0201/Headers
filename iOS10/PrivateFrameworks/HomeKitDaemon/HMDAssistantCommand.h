...
- (_Bool)populateResult:(id)arg1 fromResponse:(id)arg2 forAction:(id)arg3 serviceType:(id)arg4 forObjects:(id)arg5;
...
- (_Bool)populateResult:(id)arg1 withService:(id)arg2 serviceType:(id)arg3 characteristic:(id)arg4 action:(id)arg5;
