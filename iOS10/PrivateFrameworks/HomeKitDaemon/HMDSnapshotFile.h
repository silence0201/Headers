...
+ (id)logCategory;
@property(retain, nonatomic) HAPOSTransaction *createSlotIdentifierTransaction; // @synthesize createSlotIdentifierTransaction=_createSlotIdentifierTransaction;
