...
- (void)_addSample:(struct HDActivityCacheStatisticsBuilderSample)arg1 toSourceTotals:(map_a52608a0 *)arg2 fromWorkout:(_Bool)arg3;
- (void)_addSamples:(const vector_e4bf223f *)arg1 toSourceTotals:(map_a52608a0 *)arg2 fromWorkout:(_Bool)arg3;
- (double)_maxTimestampInSourceTotals:(const map_a52608a0 *)arg1;
- (double)_minTimestampInSourceTotals:(const map_a52608a0 *)arg1;
- (_Bool)_sourceMapIsEmpty:(const map_a52608a0 *)arg1;
